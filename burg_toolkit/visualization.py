...
def plot_contacts_normals(mesh, cp1,cp2,normal1,normal2,score):
    ...
    c2_vis = o3d.geometry.TriangleMesh.create_sphere(radius=0.005)
    ...
    if isinstance(mesh, o3d.geometry.TriangleMesh):
        point_cloud = mesh_processing.poisson_disk_sampling(mesh, n_points=np.max([1500, len(mesh.triangles)]))
